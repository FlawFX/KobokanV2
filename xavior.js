...
_sewa.expiredCheck(xavior, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${'©KoboKanaeru'} | Runtime : ${runtime(uptime)}`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*Kalian Bisa Cek Yt KoboKanaeru:*
https://youtube.com/channel/UCTVeRHM0v0Hqv_-O8yVkFpw
...
let btn = [{
                        ...
                        xavior.send5ButImg(m.chat, anu, '©KoboKanaeru', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '©KoboKanaeru', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '©KoboKanaeru', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '©KoboKanaeru', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '©KoboKanaeru', global.thumb, btn)
                        }
                     }
            break
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©KoboKanaeru', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©KoboKanaeru', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Group`, '©KoboKanaeru', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Edit Info`, '©KoboKanaeru', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Antilink`, '©KoboKanaeru', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'©KoboKanaeru'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'©KoboKanaeru'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await xavior.sendButtonText(m.chat, buttons, `Mute Bot`, '©KoboKanaeru', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '©KoboKanaeru', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/UCTVeRHM0v0Hqv_-O8yVkFpw'
                                }
                                }, {
                                urlButton: {
                                  displayText: 'Website Bot',
                                    url: 'https://wa.me/qr/CCGHWM56YEQPK1'
                                }
                                }, {
                                quickReplyButton: {
                      ...
                      xavior.send5ButImg(i, txt, '©KoboKanaeru', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      xavior.send5ButImg(yoi, txt, '©KoboKanaeru', global.thumb, btn)
		}
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            xavior.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'©KoboKanaeru'}.mp3`}, { quoted : m })
            }
            break
	    ...
	    case 'yts': case 'ytsearch': {
                if (!text) throw `Example : ${prefix + command} KoboKanaeru`
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '©KoboKanaeru', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await xavior.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©KoboKanaeru', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await xavior.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©KoboKanaeru', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '©KoboKanaeru', m)
                }
                break
            }
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, '©KoboKanaeru', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/62895604670507?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  SHOPPEPAY
├  DANA
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/[62895604670507]?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  SHOPPEPAY
├  SHOPPEPAY2
...
let btn = [{
            ...
            break
case 'shoppepay': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7eaa85c9df1868aeefb81.jpg' }, caption: `shoppepay` }, { quoted: m })
            }
            break
case 'dana': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/01b06f460df6ce9947399.jpg' }, caption: `Dana` }, { quoted: m })
            }
            break
case 'pulsa': {
m.reply('0895604670507')
}
break
// Button List
case 'command':{
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Haloo ${pushname} Saya Adalah Kobo Kaneruu MD\n\nJika ${pushname} Ingin Melihat Klik Dibawah Sini\n`,
                    description: "Klik Aja deck🗿👇",
                    buttonText: "Kobo MENU",
                    footerText: "KoboKanaeru",
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "Search Menu",
										"description": "Lu Jangan Cari 18+ Disini 🗿",
...
🤖 : Script Gak Dijual, Tapi Bisa Tanya Owner

👦 : Boleh Masukin Ke Grup Saia
Tidak?
🤖 : Chat Wa Owner Aja Pasti Boleh

👦 : Apakah Bot Ini Masih
Menyimpan File Yang Saya Kirim?
🤖 : Tidak Bro Santai Saja
Membersihkan File Setiap Jam 12 Malam 
